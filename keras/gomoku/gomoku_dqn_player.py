...
class DqnAgent:
	def __init__(self):
		...
		print()
		if (os.path.isfile(os.getcwd() + './save_model/dqn.h5') == True):
			self.epsilon = 0.5
...
def dqn_vs_dqn():
	...
	for e in range(EPISODES):
		...
		# 100 에피소드마다 모델 저장
		if e % 25 == 0:
			player.model.save_weights("./save_model/dqn.h5")
...
def dqn_vs_minimax():
	...
	for e in range(EPISODES):
		...
		# 100 에피소드마다 모델 저장
		if e % 25 == 0:
			player1.model.save_weights("./save_model/dqn.h5")
			print("Model is saved !")
			print()
			#time.sleep(1)
# [END] dqn vs dqn

# [START] dqn-player vs minimax-player 학습
if __name__ == "__main__":
	dqn_vs_dqn()
	#dqn_vs_minimax()
# [END] dqn-player vs minimax-player 학습